function ClimateChange() {
  ...
  this.setup = function() {
    ...
    this.select.position(width / 1.3, 10);
      
    //options for the select bar
    this.select.option('purple', 255);
    this.select.option('blue', 110);
    this.select.option('light blue', 50);
      
    // Create a select DOM element.
    this.sel = createSelect();
    this.sel.position(width / 1.1, 10);
      
    //options for the select bar
    this.sel.option('pink', 20);
    this.sel.option('light green', 130);
    this.sel.option('green', 90);
  };
...
//      noLoop();
    ...
    //draws the colour of the chart, and you can choose the colours from the sliders
    //the above DOM manipulation the values of
    //this.sel.value() and this.select.value() are the colours you can choose
    ...
    var red =  map(value,
                   ...
                   0,
                   255);
    return color(red, this.sel.value(), this.select.value(), 100);
    };
