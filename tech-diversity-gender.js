function TechDiversityGender() {
  ...
  this.femaleColour = color(255, 105, 97);
  this.maleColour = color(109, 231, 109);

  // Middle of the plot: for 50% line.    
  this.midX = (this.layout.plotWidth() / 2) + this.layout.leftMargin;

  // 25% of the plot line 
  this.X25 = (this.layout.plotWidth() / 4) + this.layout.leftMargin;
    
  // 75% of the plot line
  this.X75 = (this.layout.plotWidth() / 4 * 3) + this.layout.leftMargin;
